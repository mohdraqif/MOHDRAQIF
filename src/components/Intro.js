      ...
      <div className="overlay">
        <section className="intro"> 
          <div className="content">
            ...
            <Link to="/journey" class="fancy-button bg-gradient1"><span>Get Started</span></Link>
            <Link to="/projects" class="fancy-button bg-gradient2"><span>Live Projects</span></Link>
          </div>
        </section>
      </div>
  );
